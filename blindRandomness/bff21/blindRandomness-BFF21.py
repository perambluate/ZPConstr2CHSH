"""
    This script is used to compute blind randomness in terms of the lower bound on 
    the von Neumann entropy H(A|XYBE) by the Brown-Fawzi-Fawzi method (arXiv:2106.13692v2)
...
ZERO_PROB = 1e-6                # Treat this value as zero for zero probability constraints
...
for cls in CLASSES:
    ...
    for i in range(N_PARAM):
        ...
        sdp_Q.get_relaxation(level=2, objective = -winProb(P, inp_probs=INP_PROB),
    ...
    results = Parallel(n_jobs=N_WORKER_LOOP, verbose=0)(
                        delayed(singleRoundEntropy)('blind', P, Z_ab, M, inputs, scenario = SCENARIO,
