...
PRIMAL_DUAL_GAP = 1e-6          # Allowable gap between primal and dual 1e-6
...
OPT_INPUT_MAP = {'chsh': (0,0), '1': (0,1), '2a': (1,1), '2b': (0,1), '2c': (0,1), '3a': (0,0), '3b': (0,1)}
...
CLASSES = ['chsh', '2a'] #['1', '2a', '2b', '2c', '3a', '3b', 'chsh']
...
for cls in CLASSES:
    ...
    # for i in range(N_POINT):
        ...
        results = singleRoundEntropy('two', P, Z_ab, M, inputs,
