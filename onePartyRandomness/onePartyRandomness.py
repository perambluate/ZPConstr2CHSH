"""
    This script is used to compute the local randomness in terms of the lower bound on
    the von Neumann entropy H(A|XYE) by Brown-Fawzi-Fawzi method (arXiv:2106.13692v2)
...
for cls in CLASSES:
    ...
    results = Parallel(n_jobs=N_WORKER_LOOP, verbose=0)(
                        delayed(singleRoundEntropy)('one', P, Z_a, M, x_star, scenario = SCENARIO,
